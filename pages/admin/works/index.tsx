    ...
    if(works){
        return (
            <>
                ...
                <section className="w-full px-[5vw] pb-[5vw] mt-[20vh] ">
                    ...
                    <div className="w-full box-border h-[73vh] flex flex-col ">
                        <div className="w-full flex flex-col justify-center items-center">
                            <h1 className="text-4xl mb-2.5">Mes travaux</h1>
                        </div>

                        <div className="mostly-customized-scrollbar contain-cards w-full grid justify-center items-center lg:grid-cols-3 gap-2.5 md:grid-cols-2 sm:grid-cols-1">
                            {works.map((work) => (
